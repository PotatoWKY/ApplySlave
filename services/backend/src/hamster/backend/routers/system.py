...
from hamster.backend.dependencies import get_data_dir, load_settings, save_settings
...
async def delete_model(request: Request) -> dict:
    ...
    from hamster.backend.routers import profile as profile_router
...
async def update_settings(body: dict) -> dict:
    ...
    allowed_keys = {"jsearch_api_key", "dry_run", "wild_mode"}
