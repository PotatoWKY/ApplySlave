...
from hamster.backend.routers import applications, discovery, profile, system
from hamster.backend.websocket_hub import WebSocketHub
...
def create_app() -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        from hamster.backend.applicator_worker import ApplicatorWorker
...
def run() -> None:
    """CLI entry: ``hamster-backend --port 8765``."""
    import uvicorn
